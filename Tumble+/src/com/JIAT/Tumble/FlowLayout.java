...
public class FlowLayout extends ViewGroup {
    ...
    //This constructor is for elements made from XML
    public FlowLayout(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            a.recycle(); //Must recycle typed array
        }
    ...
    //Some setters for setting padding programmatically
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (lp.horizontalSpacing > 0) {
            ...
            canvas.drawLine(x, y - 4.0f, x, y + 4.0f, painter);
            canvas.drawLine(x, y, x + lp.horizontalSpacing, y, painter);
            canvas.drawLine(x + lp.horizontalSpacing, y - 4.0f, x + lp.horizontalSpacing, y + 4.0f, painter);
        }
        if (lp.breakLine) {
            float x = child.getRight();
            float y = child.getTop() + child.getHeight() / 2.0f;
            canvas.drawLine(x, y, x, y + 6.0f, painter);
            canvas.drawLine(x, y + 6.0f, x + 6.0f, y + 6.0f, painter);
        }
        return more;
    }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            ...
            try {
                horizontalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_LayoutParams_layoutSpacing, -1);
